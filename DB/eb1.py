...
if __name__ == '__main__':
    ...
    while True:
            ...
            if len(ids_to_scrape) > 0:
                ...
                for row in req.json()['events']:
                    try:
                        ...
                        data = {}
                        data['Event Name'] = row['name']
                        #data['organizer_facebook'] = row['primary_organizer']['facebook']
                        data['Organizer Name'] = row['primary_organizer']['name']
        ...
        df = pd.read_csv('eventbrite.csv', delimiter=",")
        output = df.where(df['primary_organizer']).dropna()
